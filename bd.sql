...
CREATE TABLE `unidades` (
  ...
  CONSTRAINT `unidades_ibfk_1` FOREIGN KEY (`id_destacamento`) REFERENCES `destacamentos` (`id_destacamento`) ON DELETE
  SET
    NULL
) ENGINE = InnoDB AUTO_INCREMENT = 9 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `vehiculos` (
  ...
  CONSTRAINT `fk_vehiculo_unidad` FOREIGN KEY (`id_unidad`) REFERENCES `unidades` (`id_unidad`) ON DELETE
  SET
    NULL
...
CREATE TABLE `chequeos_vehiculo` (
  ...
  CONSTRAINT `fk_chequeo_vehiculo` FOREIGN KEY (`placa`) REFERENCES `vehiculos` (`placa`) ON DELETE CASCADE
...
CREATE TABLE `chequeo_items` (
  ...
  CONSTRAINT `fk_item_chequeo` FOREIGN KEY (`id_chequeo`) REFERENCES `chequeos_vehiculo` (`id_chequeo`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `seguros` (
  ...
  CONSTRAINT `fk_seguro_vehiculo` FOREIGN KEY (`placa`) REFERENCES `vehiculos` (`placa`) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `accidentes` (
  ...
  CONSTRAINT `fk_accidente_vehiculo` FOREIGN KEY (`placa`) REFERENCES `vehiculos` (`placa`) ON DELETE CASCADE,
  CONSTRAINT `fk_accidente_seguro` FOREIGN KEY (`id_seguro`) REFERENCES `seguros` (`id_seguro`) ON DELETE
  SET
    NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
INSERT INTO
  tipos_reparacion (nombre, categoria)
VALUES
...
INSERT INTO
  destacamentos (nombre, departamento, municipio, descripcion)
VALUES
  (
  ...
  (
    'Escuela de Adiestramiento y de Rescate',
    'Guatemala',
    'Zona 16',
    'Escuela BHR'
  ),
  (
    'Compañia de Apoyo de Servicios',
    'Guatemala',
    'Zona 13',
    'Apoyo de Servicios BHR'
  );
...
VALUES
  ...
  (
    ...
    'Coronel',
    'Sanidad Militar',
    'Hilda Obeyda Gonzalez Klusmann',
    'Comandante BHR',
    'COMTE_BHR'
  ),
  (
    ...
    'Coronel',
    'Infantería',
    'Luis Alfredo Escobar García',
    'Segundo Comandante BHR',
    'COMTE_BHR'
  ),
  (
    '470963',
  ...
  (
    ...
    'Capitán Primero',
    'Infantería',
    'Fredy Antonio Velasco Flores',
    'Comandante Cía AA/SS',
    'COMTE_CIA'
  ),
  (
    '608661',
    'Capitán Segundo',
    'Infantería',
    'Sergio Haroldo Chajon Palomo',
    'Ejecutivo de Cía AA/SS',
    'COMTE_CIA'
  ),
  (
    '648782',
    'Teniente',
    'Intendencia',
    'Sulma Judith Castillo Pineda',
    'Comandante Ptn. Transportes',
    'COMTE_PTN'
  );
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum(
    ...
    'COMTE_CIA',
    'COMTE_PTN'
  ) NOT NULL DEFAULT 'COMTE_PTN',
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  `primer_ingreso` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`catalogo`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

docker exec mysql - db mysql - u root - pBHR_Server_2026 ! bhr_functions - e "
INSERT INTO tipos_servicio (nombre, descripcion, intervalo_km, intervalo_dias) VALUES
('Cambio de Aceite (Motor)', 'Aceite de motor', 5000, 30),
('Cambio de Filtro de Aceite (Motor)', 'Filtro de aceite del motor', 5000, 30),
('Cambio de Filtro de Cabina', 'Filtro de habitaculo / aire acondicionado', 5000, 30),
('Cambio de Filtro de Motor', 'Filtro de aire del motor', 5000, 30),
('Cambio de Filtro de Combustible', 'Filtro de combustible', 5000, 30),
('Cambio de Aceite de Caja', 'Aceite de transmision', 5000, 30),
('Cambio de Aceite del Diferencial', 'Aceite de diferencial', 5000, 30),
('Cambio de Llantas', 'Llantas del vehiculo', 5000, 30),
('Cambio de Bujias', 'Bujias de encendido', 5000, 30),
('Cambio de Liquido de Frenos', 'Liquido de frenos DOT', 5000, 30),
('Cambio de Refrigerante', 'Liquido refrigerante del motor', 5000, 30),
('Cambio de Bateria (Acumulador)', 'Bateria del vehiculo', 5000, 30),
('Limpieza de Inyectores', 'Limpieza del sistema de inyeccion', 5000, 30),
('Revision de Fluidos', 'Refrigerante, frenos, direccion, limpiaparabrisas', 5000, 30),
('Revision de Bateria', 'Prueba de carga y bornes', 5000, 30),
('Cambio de Correa de Distribucion', 'Correa o cadena de distribucion', 5000, 30),
('Revision de Suspension', 'Amortiguadores, rotulas, terminales', 5000, 30),
